...
reg_question <- read.csv("data/reg_question.csv", encoding = "UTF-8", na.strings = "NA")
individual_registered <- read.csv("data/individual_registered.csv", encoding = "UTF-8", na.strings = "NA")
difficulties_encountered <- read.csv("data/difficulties_encountered.csv", encoding = "UTF-8", na.strings = "NA")
...
for (i in 1:nrow(chapters) )
{
  ...
  cat("reg_question <- read.csv(paste0(mainDirroot,\"/data/reg_question.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep = "\n", append = TRUE)
  cat("individual_registered <- read.csv(paste0(mainDirroot,\"/data/individual_registered.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep = "\n", append = TRUE)
  cat("difficulties_encountered <- read.csv(paste0(mainDirroot,\"/data/difficulties_encountered.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep = "\n", append = TRUE)
