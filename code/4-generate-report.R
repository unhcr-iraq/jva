...
household <- read.csv("data/household1.csv", encoding="UTF-8", na.strings="NA")
reg_question <- read.csv("data/reg_question1.csv", encoding="UTF-8", na.strings="NA")
individual_registered <- read.csv("data/individual_registered1.csv", encoding="UTF-8", na.strings="NA")
difficulties_encountered <- read.csv("data/difficulties_encountered1.csv", encoding="UTF-8", na.strings="NA")
...
for( i in 1:nrow(chapters) )
{
  ...
  cat("household <- read.csv(paste0(mainDirroot,\"/data/household1.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep="\n", append=TRUE)
  cat("reg_question <- read.csv(paste0(mainDirroot,\"/data/reg_question1.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep="\n", append=TRUE)
  cat("individual_registered <- read.csv(paste0(mainDirroot,\"/data/individual_registered1.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep="\n", append=TRUE)
  cat("difficulties_encountered <- read.csv(paste0(mainDirroot,\"/data/difficulties_encountered1.csv\"), encoding=\"UTF-8\", na.strings=\"NA\")", file=chapter.name , sep="\n", append=TRUE)

  cat("## label Variables", file=chapter.name , sep="\n", append=TRUE)
  cat("household <- kobo_label(household , dico)", file=chapter.name , sep="\n", append=TRUE)
  cat("reg_question <- kobo_label(reg_question , dico)", file=chapter.name , sep="\n", append=TRUE)
  cat("individual_registered <- kobo_label(individual_registered , dico)", file=chapter.name , sep="\n", append=TRUE)
  cat("difficulties_encountered <- kobo_label(difficulties_encountered , dico)", file=chapter.name , sep="\n", append=TRUE)
 ...
 #  cat("household.survey <- svydesign(ids = ~ 1 ,  data = household )", file = chapter.name , sep="\n", append=TRUE)
  # cat("reg_question.survey <- svydesign(ids = ~ 1  ,  data = reg_question)", file=chapter.name , sep="\n", append=TRUE)
 # cat("individual_registered.survey <- svydesign(ids = ~ 1  ,  data = individual_registered)", file=chapter.name , sep="\n", append=TRUE)
